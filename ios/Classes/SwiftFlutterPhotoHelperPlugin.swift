...
public class SwiftFlutterPhotoHelperPlugin: NSObject, FlutterPlugin, PHPhotoLibraryChangeObserver {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "thumbnail":
      ...
      PhotosHelper.thumbnail(id, assetId, width, height, quality, result, messenger)
      break;
    case "original":
      let arguments = call.arguments as! Dictionary<String, AnyObject>
      let id = arguments["id"] as! String
      ...
      PhotosHelper.original(id, assetId, quality, result, messenger)
      break;
    case "thumbnailFile":
      let arguments = call.arguments as! Dictionary<String, AnyObject>
      let id = arguments["id"] as! String
      ...
      PhotosHelper.thumbnailFile(id, assetId, width, height, quality, result)
      break;
    case "originalFile":
      let arguments = call.arguments as! Dictionary<String, AnyObject>
      let id = arguments["id"] as! String
      ...
      PhotosHelper.originalFile(id, assetId, quality, result)
      break;
